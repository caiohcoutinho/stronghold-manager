...
export const selectUserByUserId = async function(user_id) {
    return await HtmlUtilities.runQuerySync(UserQueries.SELECT_USER_BY_USER_ID, [user_id]).rows[0];
}

export const createUser = async function(id, name, email, picture) {
    return await HtmlUtilities.runQuerySync(UserQueries.CREATE_USER, [id, name, email, picture]).rows[0];
}
